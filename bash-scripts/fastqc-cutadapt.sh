...
#SBATCH -o /scratch4/workspace/jade_fiorilla_student_uml_edu-rawseqorcc/slurm-fastqc-cutadapt-%j.out  # %j = job ID
...
FILEPATH='/scratch4/workspace/jade_fiorilla_student_uml_edu-rawseqorcc/trimmed-cutadapt'
OUTPUT_RESULTS='/scratch4/workspace/jade_fiorilla_student_uml_edu-rawseqorcc/trimmed-cutadapt/fastqc'

# Create filename if not already created
ls $FILEPATH -1 | sed 's/_R.*_trim.fastq//' | uniq > "$OUTPUT_RESULTS/sampleids.txt"

SAMPLE_NAMES_FILE="/scratch4/workspace/jade_fiorilla_student_uml_edu-rawseqorcc/trimmed-cutadapt/fastqc/sampleids.txt"
...
while IFS= read -r sample_id; do
    ...
    input_r1="$FILEPATH/${sample_id}_R1_trim.fastq"
    input_r2="$FILEPATH/${sample_id}_R2_trim.fastq"
